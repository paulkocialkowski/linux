...
{
	int i;
	struct coda_memcpy_desc huff[8] = {
		{
			0,
			v4l2_jpeg_default_dht_luma_dc.start,
			v4l2_jpeg_default_dht_luma_dc.length
		},
		{
			32,
			v4l2_jpeg_default_dht_luma_ac.start,
			v4l2_jpeg_default_dht_luma_ac.length
		},
		{
			216,
			v4l2_jpeg_default_dht_chroma_dc.start,
			v4l2_jpeg_default_dht_chroma_dc.length
		},
		{
			248,
			v4l2_jpeg_default_dht_chroma_ac.start,
			v4l2_jpeg_default_dht_chroma_ac.length
		},
	};
				       ...
				       int *ehufsi, int *ehufco)
{
	...
	unsigned char *huff_tabs[4] = {
		v4l2_jpeg_default_dht_luma_dc_data,
		v4l2_jpeg_default_dht_luma_ac_data,
		v4l2_jpeg_default_dht_chroma_dc_data,
		v4l2_jpeg_default_dht_chroma_ac_data,
	};
	int ret = -EINVAL;
...
static int coda9_jpeg_encode_header(struct coda_ctx *ctx, int len, u8 *buf)
{
	...
	struct coda_q_data *q_data_src;
	const u8 *luma_dc = v4l2_jpeg_default_dht_luma_dc_data;
	const u8 *luma_ac = v4l2_jpeg_default_dht_luma_ac_data;
	const u8 *chroma_dc = v4l2_jpeg_default_dht_chroma_dc_data;
	const u8 *chroma_ac = v4l2_jpeg_default_dht_chroma_ac_data;
