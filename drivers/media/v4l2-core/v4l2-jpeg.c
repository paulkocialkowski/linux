...
/*
 * Default Huffman tables for 8-bit precision, as specified by ITU-T.81
 * (ISO/IEC 10918-1) Annex K.3. Note that the specification does not define
 * these as fallback defaults but it is the expected common practice to use
 * them when no explicit DHT tag is provided in the JPEG stream.
 */

u8 v4l2_jpeg_default_dht_luma_dc_data[] = {
	/* bits */
...
EXPORT_SYMBOL_GPL(v4l2_jpeg_default_dht_luma_dc_data);

const struct v4l2_jpeg_reference v4l2_jpeg_default_dht_luma_dc = {
	.start	= v4l2_jpeg_default_dht_luma_dc_data,
	.length	= ARRAY_SIZE(v4l2_jpeg_default_dht_luma_dc_data),
};

EXPORT_SYMBOL_GPL(v4l2_jpeg_default_dht_luma_dc);

u8 v4l2_jpeg_default_dht_luma_ac_data[] = {
	/* bits */
...
EXPORT_SYMBOL_GPL(v4l2_jpeg_default_dht_luma_ac_data);

const struct v4l2_jpeg_reference v4l2_jpeg_default_dht_luma_ac = {
	.start	= v4l2_jpeg_default_dht_luma_ac_data,
	.length	= ARRAY_SIZE(v4l2_jpeg_default_dht_luma_ac_data),
};

EXPORT_SYMBOL_GPL(v4l2_jpeg_default_dht_luma_ac);

u8 v4l2_jpeg_default_dht_chroma_dc_data[] = {
	/* bits */
...
EXPORT_SYMBOL_GPL(v4l2_jpeg_default_dht_chroma_dc_data);

const struct v4l2_jpeg_reference v4l2_jpeg_default_dht_chroma_dc = {
	.start	= v4l2_jpeg_default_dht_chroma_dc_data,
	.length	= ARRAY_SIZE(v4l2_jpeg_default_dht_chroma_dc_data),
};

u8 v4l2_jpeg_default_dht_chroma_ac_data[] = {
	/* bits */
...
EXPORT_SYMBOL_GPL(v4l2_jpeg_default_dht_chroma_ac_data);

const struct v4l2_jpeg_reference v4l2_jpeg_default_dht_chroma_ac = {
	.start	= v4l2_jpeg_default_dht_chroma_ac_data,
	.length	= ARRAY_SIZE(v4l2_jpeg_default_dht_chroma_ac_data),
};

EXPORT_SYMBOL_GPL(v4l2_jpeg_default_dht_chroma_ac);
