...
struct page *dma_alloc_from_contiguous(struct device *dev, size_t count,
				       unsigned int size, bool no_warn);
...
static inline struct page *dma_alloc_from_contiguous(struct device *dev,
		size_t count, unsigned int size, bool no_warn)
{
	return NULL;
}
...
static inline void dma_free_contiguous(struct device *dev, struct page *page,
		size_t size)
{
	__free_pages(page, get_size(size));
}
...
int dma_release_from_global_coherent(int size, void *vaddr);
...
#define dma_mmap_from_dev_coherent(dev, vma, vaddr, size, ret) (0)
...
static inline int dma_release_from_global_coherent(int size, void *vaddr)
{
	return 0;
}
